<?php
// 代码基于 TinaTheme，原作者 Magneto 。 
// https://github.com/ouyangyanhuo/TinaTheme/blob/b984475a31d9b7fa1b93f7b3514a3fe6f0458104/comments.php
    ...
    <div id="<?php $comments->theId(); ?>">
        ...
        <div class="comment-meta">
            ...
            <?php if ($comments->status == 'waiting') { ?>
                <div class="alert alert-primary" role="alert">评论审核中。</div>
...
<div id="comments">
	...
	<h4 class="comments-title-article-post my-4"><?php $this->commentsNum(_t('暂无评论'), _t('1 条评论'), _t('%d 条评论')); ?></h4>
